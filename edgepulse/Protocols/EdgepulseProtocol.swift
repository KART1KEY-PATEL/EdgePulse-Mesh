...
/// # EdgepulseProtocol
///
/// Defines the application-layer protocol for EdgePulse mesh networking, including
/// message types, packet structures, and encoding/decoding logic.
///
/// ## Overview
/// EdgepulseProtocol implements a binary protocol optimized for Bluetooth LE's
...
/// Simplified EdgePulse protocol message types.
...
protocol EdgepulseDelegate: AnyObject {
