...
extension EdgepulseMessage: Equatable {
    static func == (lhs: EdgepulseMessage, rhs: EdgepulseMessage) -> Bool {
...
extension Array where Element == EdgepulseMessage {
