...
/// Represents a peer in the EdgePulse network with all associated metadata
struct EdgepulsePeer: Equatable {
    ...
    static func == (lhs: EdgepulsePeer, rhs: EdgepulsePeer) -> Bool {
