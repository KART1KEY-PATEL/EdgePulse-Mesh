...
struct MeshPeerList: View {
    ...
    var body: some View {
        ...
        let mapped: [(peer: EdgepulsePeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = viewModel.allPeers.map { peer in
        ...
        let peers: [(peer: EdgepulsePeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = displayIDs.compactMap { id in
