        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .center, spacing: 8) {
                Text(Strings.appName)
                    .font(.edgepulseSystem(size: 32, weight: .bold, design: .monospaced))
                    .foregroundColor(textColor)
                
                Text(Strings.tagline)
                    .font(.edgepulseSystem(size: 16, design: .monospaced))
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text(info.title)
                    .font(.edgepulseSystem(size: 14, weight: .semibold, design: .monospaced))
                    .foregroundColor(textColor)
