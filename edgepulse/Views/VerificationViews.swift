    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(Strings.pastePrompt)
                .font(.edgepulseSystem(size: 14, weight: .medium, design: .monospaced))
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Text("verification.sheet.title")
                    .font(.edgepulseSystem(size: 14, weight: .bold, design: .monospaced))
                ...
                Button(action: {
                    ...
                    Image(systemName: "xmark")
                        .font(.edgepulseSystem(size: 14, weight: .semibold))
                        .foregroundColor(accentColor)
                }
                .buttonStyle(.plain)
            }
                ...
                if showingScanner {
                    ...
                    Button(action: { showingScanner = true }) {
                        Label("scan someone else's qr", systemImage: "camera.viewfinder")
                            .font(.edgepulseSystem(size: 13, weight: .medium, design: .monospaced))
                    }
                    .buttonStyle(.bordered)
                    .tint(.gray)
                }
