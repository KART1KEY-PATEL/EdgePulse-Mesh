...
final class KeychainManager: KeychainManagerProtocol {
    ...
    private let service = EdgepulseApp.bundleID
    private let appGroup = "group.\(EdgepulseApp.bundleID)"
    ...
    private func saveData(_ data: Data, forKey key: String) -> Bool {
        ...
        var base: [String: Any] = [
            ...
            kSecAttrLabel as String: "edgepulse-\(key)"
        ]
        #if os(macOS)
        ...
        if searchStatus == errSecSuccess, let items = result as? [[String: Any]] {
            for item in items {
                ...
                if accessGroup == appGroup {
                    ...
                    "com.edgepulse.passwords",
                    "com.edgepulse.deviceidentity",
                    "com.edgepulse.noise.identity",
                    "chat.edgepulse.passwords",
                    "edgepulse.keychain",
                    "edgepulse",
                    "com.edgepulse"
                ].contains(service) {
