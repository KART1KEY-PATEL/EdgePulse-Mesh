...
final class PublicMessagePipeline {
    ...
    private var buffer: [EdgepulseMessage] = []
    ...
    func enqueue(_ message: EdgepulseMessage) {
...
private extension PublicMessagePipeline {
    ...
    func flushBuffer() {
        ...
        var pending: [(message: EdgepulseMessage, contentKey: String)] = []
    ...
    func insertionIndex(for timestamp: Date, in messages: [EdgepulseMessage]) -> Int {
        var low = 0
