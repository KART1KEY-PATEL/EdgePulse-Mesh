...
- **File:** `edgepulseTests/Mocks/MockBLEService.swift`
...
- **Handlers:** Tests can observe data via `messageDeliveryHandler` (decoded `EdgepulseMessage`) and `packetDeliveryHandler` (raw `EdgepulsePacket`).
