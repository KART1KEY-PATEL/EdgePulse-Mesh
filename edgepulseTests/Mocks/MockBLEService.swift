...
final class MockBLEService: NSObject {
    ...
    var sentMessages: [(message: EdgepulseMessage, packet: EdgepulsePacket)] = []
    var sentPackets: [EdgepulsePacket] = []
    var connectedPeers: Set<PeerID> = []
    var messageDeliveryHandler: ((EdgepulseMessage) -> Void)?
    var packetDeliveryHandler: ((EdgepulsePacket) -> Void)?
    ...
    func sendFileBroadcast(_ packet: EdgepulseFilePacket, transferId: String) {
        // Tests currently ignore file transfer flows; keep stub for protocol conformance.
    }

    func sendFilePrivate(_ packet: EdgepulseFilePacket, to peerID: PeerID, transferId: String) {
        // Tests currently ignore file transfer flows; keep stub for protocol conformance.
    }
    ...
    func simulateIncomingMessage(_ message: EdgepulseMessage) {
    ...
    func simulateIncomingPacket(_ packet: EdgepulsePacket) {
        // Process through the actual handling logic
        if let message = EdgepulseMessage(packet.payload) {
