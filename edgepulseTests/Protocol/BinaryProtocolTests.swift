...
struct BinaryProtocolTests {
    ...
    @Test func messageEncodingDecoding() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to decode message from binary")
    ...
    func testPrivateMessageEncoding() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to decode private message")
    ...
    @Test func messageWithMentions() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to decode message with mentions")
    ...
    @Test func relayMessageEncoding() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to decode relay message")
    ...
    func largeMessageHandling() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to handle large message")
    ...
    func emptyFieldsHandling() throws {
        ...
        let decodedMessage = try #require(EdgepulseMessage(payload), "Failed to handle empty message")
