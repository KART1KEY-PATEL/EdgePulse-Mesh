...
struct NotificationStreamAssemblerTests {
    private func makePacket(timestamp: UInt64 = 0x0102030405) -> EdgepulsePacket {
    ...
    func testAssemblesCompressedLargeFrame() throws {
        ...
        let decodedFile = try #require(EdgepulseFilePacket.decode(decodedPacket.payload), "Failed to decode TLV payload")
